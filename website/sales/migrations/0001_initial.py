    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sale', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='sales.AssetSale')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='assets',
            field=models.ManyToManyField(through='sales.SingleAssetSale', to='assets.Asset'),
        ),
        migrations.AddField(
            model_name='assetsale',
            name='contact',
